...
namespace UnitTestProject1
{
    ...
    {
        Trader t1, t2;
        List<I_Commodity> pf1 = new List<I_Commodity>() { new Commodity(0), new Commodity(1), new Commodity(0), new Commodity(1) };
        ...
        {
            Assert.IsTrue(t1.DesireFor(new Commodity(0)) == dp1[0]);
            Assert.IsTrue(t1.DesireFor(new Commodity(1)) == dp1[1]);
        }
        ...
        public void CapitalistSatisfaction()
        {
            ...
            //Owns t1
            List<I_Commodity> pf2 = new List<I_Commodity>() {
                new Commodity(0),
                new Commodity(1),
                new Commodity(0),
                t1
            ...
            //Owns t2, t2 own t1
            List <I_Commodity> pf3 = new List<I_Commodity>() {
                new Commodity(0),
                new Commodity(1),
                new Commodity(0),
                t2
